      ...
      <div className={style.inner}>
        ...
        <Container size={640}>
          <Text size="lg" className={style.description}>
            Explore ways to monitor your properties. Keep in touch with both
            land and home owners. Create a centralized information database.
            Integrate data analytics to get better insight of your business.
          </Text>
        </Container>
